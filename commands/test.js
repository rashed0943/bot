            ...
            .then(collected => {
              if (!collected.first().content.match(/[1-60][s,m,h,d,w]/g))
                return message.channel.send(
                  "Wrong Time format EXample: \n1s / 1m /1h / 1d/ 1w"
                );
              duration = collected.first().content;
              collected.first().delete();
              msg
                .edit("please now send what do you want as a gift?")
                .then(msg => {
                  message.channel
                    .awaitMessages(filter, {
                      max: 1,
                    ...
                    .then(collected => {
                      ...
                      try {
                        let giveEmbed = new Discord.RichEmbed()
                          ...
                          .setTitle(`${title}`)
                          .setThumbnail(
                            "https://media.discordapp.net/attachments/635116976510861321/662679694759690270/image0.gif"
                          )
                          .setDescription(
                            ...
                            setTimeout(() => {
                              ...
                              if (gFilter === undefined) {
                                ...
                                let endEmbed = new Discord.RichEmbed()
                                  ...
                                  .setTitle(title)
                                  .setThumbnail(
                                    "https://media.discordapp.net/attachments/596716658857345026/671050749891051531/image0.png"
                                  )
